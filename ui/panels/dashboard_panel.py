...
STYLE_MAP = {
    "SBQI":  {"color": "blue",   "marker": "d", "label": "SBQI"},
    "OFBQI": {"color": "#FF6600", "marker": "o", "label": "OFBQI"}
}

MODE_DISTRIBUTION = "Degree Distribution"
MODE_EVOLUTION_N = "Evolution (N)"
...
class DashboardPanel(ctk.CTkFrame):
    ...
    def _run_logic_in_thread(self, data):
        ...
        except Exception as e: self.simulation_result = {"error": str(e)}
    ...
    def _check_simulation_status(self):
        ...
        if self.is_simulating and not self.simulation_thread.is_alive():
            ...
            if res and "cancelled" in res:
                ...
                final_r = res.get('final_radius', 1000)
    ...
    def draw_distribution_chart(self, x_values, y_values, net_type, keep_plot):
        ...
        except Exception as e: print(f"Dist Error: {e}")
    ...
    def draw_evolution_charts(self, x_nodes, y_path, y_diam, net_type, keep_plot):
        try:
            ...
            self.canvas_right.draw()
        except Exception as e: print(f"Evo Error: {e}")
    ...
    def create_top_menu(self):
        ...
        self.lbl_nodes, self.entry_nodos = self._add_top_input(grp_common, "Nodes", "1000", width=50)
        self._add_top_combo(grp_common, "Type", ["SBQI", "OFBQI"])
        
        self.lbl_radius, self.entry_radius = self._add_top_input(grp_common, "Radius", "1261", width=50) 
        
        _, self.entry_mc_iter = self._add_top_input(grp_common, "MC Reps", "5", width=40)

        self.frame_steps = ctk.CTkFrame(self.header, fg_color="transparent")
        _, self.entry_steps = self._add_top_input(self.frame_steps, "Steps", "5", width=40)
        
        self.frame_incr = ctk.CTkFrame(self.header, fg_color="transparent")
        self.lbl_incr, self.entry_incr = self._add_top_input(self.frame_incr, "N Incr", "100", width=40)
